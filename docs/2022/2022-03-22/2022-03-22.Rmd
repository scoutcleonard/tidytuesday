...
ggplot(data = scout, aes(x = year, y = n)) +
  ...
  theme(plot.margin = margin(rep(15, 4)),
        ...
        plot.title = element_text(size = 20, hjust = 0.5, color = "#41485f", family = "EB Garamond"),
        plot.subtitle = element_text(hjust = 0.5, color = "#41485f", family = "EB Garamond"),
        axis.title = element_text(color = "#41485f", family = "EB Garamond")) +
  geom_text(x = 1963, 
            y = 225, 
